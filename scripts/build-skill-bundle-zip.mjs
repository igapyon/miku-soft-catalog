...
const bundleDirName = "mikuproject-skills-java";
...
const zipFileName = `mikuproject-skills-java-${buildDate}.zip`;
...
function main() {
  if (!fs.existsSync(bundleRoot)) {
    throw new Error("missing bundle/mikuproject-skills-java. run build:bundle first.");
  }
